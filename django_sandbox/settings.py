...
DATABASES = {
    'default': {
        ...
        'NAME': 'D:/Unshared/Python/Python Eclipse workspace/django_sandbox/django_sandbox/databases/sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '46qgli48a=@*5e^(g()c9sa!wfy^o1r#4!vy=qpor5ngiytgy9'
